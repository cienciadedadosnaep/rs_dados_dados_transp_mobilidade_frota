...
df = pd.read_csv('C:/Users/carol/OneDrive/Área de Trabalho/Códigos/rs_dados_dados_transp_mobilidade_frota/data/POVOAMENTO.csv', sep = ';')
...
for i in range(0,len(df)):
    ...
    code = list(pd.read_csv('C:/Users/carol/OneDrive/Área de Trabalho/Códigos/rs_dados_dados_transp_mobilidade_frota/data/'+codigol1[i],sep=';', encoding= 'latin-1'))
